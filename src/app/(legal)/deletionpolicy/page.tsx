...
const DeletionpolicyPage = () => {
  return (
    <div className={cn("container")}>
      ...
      <ol>
        <li>1. 프로필 페이지로 이동합니다.</li>
        <li>
          2. <strong>계정 삭제</strong>를 클릭합니다.
        </li>
        <li>
          3. 계정 삭제 페이지에서 계정 삭제 이유를 선택한 후 삭제 버튼을
          클릭합니다.
        </li>
        <li>4. 삭제 확인 메시지에 동의하여 계정을 삭제할 수 있습니다.</li>
      </ol>
      <p>
      ...
      <ul>
        <li>1. 자신이 올린 게시물을 삭제할 수 있는 기능을 사용하세요.</li>
        <li>
          2. 삭제하려는 게시물에서 <strong>삭제</strong> 버튼을 클릭한 후, 확인
          메시지에 동의하여 삭제를 완료하세요.
        </li>
      </ul>
      <br />
