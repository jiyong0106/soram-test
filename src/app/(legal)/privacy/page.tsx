  ...
  return (
    <div className={cn("container")}>
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>
            1. 회사는 이용자의 개인정보를 제1조에서 정한 목적을 달성할 때까지
            계속적으로 보유하며, 서비스 제공 등을 위해 이용하고 목적이 달성되면
            파기됩니다.
          </li>
          <li>
            2. 다만, 제1조에서 정한 목적 달성 시 즉시파기 원칙에도 불구하고
            다음과 같이 거래 관련 권리 의무 관계의 확인 등을 이유로 일정기간
            보유하여야 할 필요가 있을 경우에는 「전자상거래 등에서의
            소비자보호에 관한 법률」, 「국세기본법」 등 관련 법령의 규정에
            근거하여 일정기간 보유합니다.
            <ul>
          ...
          <li>
            3. 이용자의 동의를 받아 보유하고 있는 거래정보 등을 이용자께서
            열람을 요구하는 경우 회사는 지체없이 열람, 확인할 수 있도록
            조치합니다.
          </li>
        </ol>
      </div>
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>
            1. 회사는 개인정보를 제1조에서 명시한 목적을 위해서만 이용하며,
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>
            1. 회사는 서비스 향상과 반드시 필요한 업무 중 일부의 수행을 위하여
          ...
          <li>
            3. SORAM는 위탁계약 체결 시 「개인정보 보호법」 제26조에 따라
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          ...
          <li>
            2. 제1항에 따른 권리 행사는 회사에 대해 「개인정보 보호법」 시행령
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          ...
          <li>
            <strong>3. 개인정보 파기의 절차 및 방법은 다음과 같습니다.</strong>
            <ul>
              <li>
                ◦ <strong>파기절차</strong>
                <br />
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>
            1. <strong>개인정보 취급 직원의 최소화 및 교육</strong>
            <br />
            개인정보를 취급하는 직원을 지정하고 담당자에 한정시켜 최소화하여
            개인정보를 관리하는 대책을 시행하고 있습니다.
          </li>
          <li>
            2. <strong>내부관리계획의 수립 및 시행</strong>
            <br />
            개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고
            있습니다.
          </li>
          <li>
            3. <strong>해킹 등에 대비한 기술적 대책</strong>
            <br />
          ...
          <li>
            5. <strong>개인정보에 대한 접근 제한</strong>
            <br />
          ...
          <li>
            6. <strong>문서보안을 위한 잠금장치 사용</strong>
            <br />
            개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가 있는 안전한
            장소에 보관하고 있습니다.
          </li>
          <li>
            7. <strong>비인가자에 대한 출입 통제</strong> <br />
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>
            1. 회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를
            저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.
          </li>
          <li>
            2. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의
            컴퓨터 브라우저에게 보내는 소량의 정보이며, 이용자들의 PC 내의
            하드디스크에 저장되기도 합니다.
            <ul>
              <li>
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          ...
          <li>
            3. 정보주체는 「개인정보 보호법」 제35조에 따른 개인정보의 열람
      ...
      <div className={cn("section-content")}>
        ...
        <ol>
          <li>1. 본 개인정보처리방침은 2024년 12월 11일부터 적용됩니다.</li>
        </ol>
      </div>
    </div>
  );
